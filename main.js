...
<img class="logo-image2" src="https://datamb.football/logopro.png" alt="">
<h3><b>${selectedPlayer.player} (${selectedPlayer.team}, ${selectedPlayer.age})</b></h3>
          <h1><i>vs All League ${titleSuffix} ${selectedPlayer.position}s, per 90</i></h1>
...
<img class="logo-image2" src="https://datamb.football/logopro.png" alt="">
<h3><b>${selectedPlayer.player} (${selectedPlayer.team}, ${selectedPlayer.age})</b></h3>
          <h1><i>vs All League ${titleSuffix} ${selectedPlayer.position}s</i></h1>
...
<img class="logo-image2" src="https://datamb.football/logopro.png" alt="">
<h3><b>${selectedPlayer.player} (${selectedPlayer.team}, ${selectedPlayer.age})</b></h3>
        <h1><i>vs All League ${titleSuffix} players, per 90</i></h1>
...
<img class="logo-image2" src="https://datamb.football/logopro.png" alt="">
<h3><b>${selectedPlayer.player} (${selectedPlayer.team}, ${selectedPlayer.age})</b></h3>
        <h1><i>vs All League ${titleSuffix} players</i></h1>
